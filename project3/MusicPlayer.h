...
const std::string FILE_NAME = "proj3_music.txt"; //Default input file
...
class MusicPlayer{
 public:
  ...
  void LoadCatalog(std::string filename);
  //Name: MainMenu
  //Precondition: None
  ...
  void ChoosePlaylist();
 private:
  std::vector<Song*> m_songCatalog; //Holds all songs in input file as songs
  std::vector<Playlist*> m_playLists;
  unsigned int chosenPlayList;
